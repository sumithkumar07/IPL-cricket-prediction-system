...
class ModelEvaluator:
    def __init__(self):
        ...
        self.feature_columns = [
            ...
            "team1_win_ratio_last3",
            "team1_win_ratio_last5",
            "team1_win_ratio_last10",
            "team2_win_ratio_last3",
            "team2_win_ratio_last5",
            "team2_win_ratio_last10",
            "team1_run_rate_last3",
            "team1_run_rate_last5",
            "team1_run_rate_last10",
            "team2_run_rate_last3",
            "team2_run_rate_last5",
            "team2_run_rate_last10",
            "team1_wicket_rate_last3",
            "team1_wicket_rate_last5",
            "team1_wicket_rate_last10",
            "team2_wicket_rate_last3",
            "team2_wicket_rate_last5",
            "team2_wicket_rate_last10",
            # Score prediction features
            "team1_powerplay_avg",
            "team1_powerplay_std",
            "team2_powerplay_avg",
            "team2_powerplay_std",
            "team1_middle_overs_avg",
            "team1_middle_overs_std",
            "team2_middle_overs_avg",
            "team2_middle_overs_std",
            "team1_death_overs_avg",
            "team1_death_overs_std",
            "team2_death_overs_avg",
            "team2_death_overs_std",
            "team1_run_rate_acceleration",
            "team2_run_rate_acceleration",
            ...
            "avg_form_runs_last3",
            "avg_form_runs_last5",
            "avg_form_runs_last10",
            "avg_form_strike_rate_last3",
            "avg_form_strike_rate_last5",
            "avg_form_strike_rate_last10",
            "avg_form_boundaries_last3",
            "avg_form_boundaries_last5",
            "avg_form_boundaries_last10",
            "avg_form_sixes_last3",
            "avg_form_sixes_last5",
            "avg_form_sixes_last10",
            "avg_wickets",
            "avg_economy_rate",
            "avg_dot_ball_percentage",
            "avg_form_wickets_last3",
            "avg_form_wickets_last5",
            "avg_form_wickets_last10",
            "avg_form_economy_last3",
            "avg_form_economy_last5",
            "avg_form_economy_last10",
            "avg_form_dot_ball_percentage_last3",
            "avg_form_dot_ball_percentage_last5",
            ...
            "team1_venue_familiarity",
            "team2_venue_familiarity",
            # Head-to-head features
            "team1_h2h_win_rate",
            "team2_h2h_win_rate",
            # Weather and pitch features
            "pitch_condition_numeric",
    ...
    def load_models(self):
        ...
        self.score_xgb_model = joblib.load(
            self.models_dir / "score_xgboost_model.joblib"
        )
        self.score_rf_model = joblib.load(
            self.models_dir / "score_random_forest_model.joblib"
        )
        self.score_nn_model = load_model(
            self.models_dir / "score_neural_network_model.keras"
        )
        self.score_ensemble_model = joblib.load(
            self.models_dir / "score_ensemble_model.joblib"
        )
    ...
    def load_test_data(self):
        ...
        self.test_data = (
            pd.read_parquet(features_file)
            if features_file.suffix == ".parquet"
            else pd.read_csv(features_file)
        )
        ...
        missing_columns = [
            col for col in self.feature_columns if col not in self.test_data.columns
        ]
        if missing_columns:
        ...
        nan_columns = (
            ...
            .columns[self.test_data[self.feature_columns].isna().any()]
            .tolist()
        )
        if nan_columns:
