...
class IPLPredictionExplainer:
    def __init__(self):
        ...
        self.voting_clf = joblib.load(self.models_dir / "voting_classifier_winner.joblib")
    ...
    def predict_winner(self, match_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            explanation = self.generate_explanation(match_data, prediction, probabilities)
    ...
    def generate_explanation(self, features: Dict[str, Any], prediction: int, probabilities: np.ndarray) -> str:
...
if __name__ == "__main__":
    ...
    # Print results
    print("\nPrediction Results:")
    print(f"Predicted Winner: {match_data['team1'] if result['prediction'] == 1 else match_data['team2']}")
    print(f"Win Probability: {result['probabilities'][1] if result['prediction'] == 1 else result['probabilities'][0]:.2%}")
    print("\nExplanation:")
