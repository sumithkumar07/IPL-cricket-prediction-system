...
def setup_chrome_driver():
    ...
    print("Chrome WebDriver not found in common locations. Will attempt automatic download.")
...
def main():
    ...
    try:
        ...
        if cache_dir.exists():
            ...
            print(f"Cache size: {sum(f.stat().st_size for f in cache_files) / 1024:.2f} KB")
