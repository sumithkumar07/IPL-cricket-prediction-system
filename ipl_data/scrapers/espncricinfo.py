...
class ESPNCricinfoScraper(BaseScraper):
    ...
    def __init__(self, cache_dir: str = "cache", data_dir: str = "ipl_data/data/raw"):
        ...
        self.stats_url = (
            f"{self.base_url}/series/indian-premier-league-2024-1410320/stats"
        )
        self.matches_url = (
            f"{self.base_url}/series/indian-premier-league-2024-1410320/matches"
        )
        self.points_url = (
            f"{self.base_url}/series/indian-premier-league-2024-1410320/points-table"
        )
        self.teams_url = (
            f"{self.base_url}/series/indian-premier-league-2024-1410320/teams"
        )
