...
class BaseScraper:
    ...
    def make_request(self, url: str, method: str = 'GET', params: Optional[Dict] = None) -> Optional[requests.Response]:
        ...
        for attempt in range(SCRAPING_CONFIG['max_retries']):
            try:
                ...
                self.logger.error(f"Request failed (attempt {attempt + 1}/{SCRAPING_CONFIG['max_retries']}): {str(e)}")
